...
$sql = "SELECT * FROM movies where movie_id in(select movie_id from towatch where username='$username')"; 
    ...
    // output data of each row
     while($row = $result->fetch_assoc()) {
        ...
        <div class="col-md-4 box5">
            <a href="deletetowatch.php?id='.$row["movie_id"].'" class="btn btn-danger"> Delete</a>
        </div>
    </div>            
        ';
    }
        ...
        <form action="" method="post">
            <div class="row">
                <div class="col-md-10 box1" style="margin-left:100px;">
                    <h3 style="margin-bottom:50px;"><span style="font-weight:bold; color: #6AC045">To Watch List </span>(<?php echo $total ?>)</h3>
                    <?php 
                    echo $list;
                    ?>
                </div>
